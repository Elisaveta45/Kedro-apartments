...
# kedro_apartments documentation build
...
from kedro_apartments import __version__ as release

# -- Project information -----------------------------------------------------

project = "kedro_apartments"
copyright = "2021, QuantumBlack Visual Analytics Limited"
author = "QuantumBlack"
...
htmlhelp_basename = "kedro_apartmentsdoc"
...
latex_documents = [
    (
        master_doc,
        "kedro_apartments.tex",
        "kedro_apartments Documentation",
        "QuantumBlack",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "kedro_apartments",
        "Project kedro_apartments codebase.",
        "Data-Science",
    )
]
